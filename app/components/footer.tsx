...
export default function Footer() {
  return (
    <div className='bg-[#141B23] flex items-center flex-col justify-center px-4 sm:px-6 lg:px-8'>
      {/* Main CTA Section */}
      <div className='flex flex-col lg:flex-row gap-4 lg:gap-2 bg-gradient-to-br from-[#19212A] from-50% w-full max-w-[1199px] min-h-[500px] lg:h-[664px] to-[#000000] mt-16 sm:mt-24 md:mt-32 lg:mt-38 py-8 sm:py-10 md:py-12 px-6 sm:px-8 md:px-12 rounded-2xl md:rounded-3xl mb-8 md:mb-10'>
        
        {/* Left Content */}
        <div className='flex flex-col w-full lg:w-[740px]'>
          <div className={`${Gloria.className} text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-[#D0F091] flex flex-col gap-1`}>
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-0 mt-6 lg:mt-0">
            <div className="flex">
              <div className="relative w-[160px] h-[153px] sm:w-[190px] sm:h-[182px] md:w-[238px] md:h-[228.58px] -mt-8 sm:-mt-10 md:-mt-12">
                 <Image src="/fot1.png" alt="footer image" fill className="object-contain" />
              </div>
              <div className="relative w-[160px] h-[153px] sm:w-[190px] sm:h-[182px] md:w-[238px] md:h-[228.58px] mt-2 sm:mt-3 md:mt-4 -ml-8 sm:-ml-10 md:-ml-12">
        ...
        <div className="hidden md:flex relative justify-center lg:justify-start">
          ...
          <div className="relative w-[204px] h-[288px] lg:w-[315.02px] lg:h-[444.47px] z-20">
      ...
      <div className="w-full max-w-[1199px] flex flex-col lg:flex-row gap-4 mb-12 sm:mb-16 md:mb-20">
        ...
        <div className="flex flex-col p-5 sm:p-6 gap-3 sm:gap-4 border border-[#2A343F] min-h-[240px] w-full lg:w-1/2 rounded-2xl md:rounded-3xl">
          <div className="relative w-[140px] h-[24.82px] sm:w-[160px] sm:h-[28.38px] md:w-[184px] md:h-[32.65px]">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-4">
          ...
          {/* Links & Social Card */}
          <div className="border border-[#2A343F] min-h-[112px] w-full rounded-2xl md:rounded-3xl gap-3 sm:gap-4 flex flex-col p-5 sm:p-6">
          ...
          {/* Copyright Card */}
          <div className="flex items-center justify-center border border-[#2A343F] min-h-[112px] w-full text-[10px] sm:text-[12px] text-[#797F86] rounded-2xl md:rounded-3xl p-4 text-center">
            <p>
